...
public class SystemUtil {
    ...
    public static String selectNetName(){
        ...
        try {
            ...
            for(String s: anames){
                ...
                if(s.contains("eth") || s.contains("enp") || s.contains("ens")|| s.contains("e"))
                    return s;
            }
            return null;
    ...
    public static boolean isPortUsing(String host,int port) throws UnknownHostException {
        ...
        try {
            ...
            LOG.error("isPortUsing:"+e.getMessage());
        }
        return flag;
    }

    public static String getMac(){
        String name = selectNetName();
        if(name == null){
            System.out.println("Get network error");
            return null;
        }
        String mac = getMACAddressFromSys(name);
        return mac;
    }
}
