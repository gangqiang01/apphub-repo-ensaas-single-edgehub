...
public interface IRepoExeRepository extends JpaRepository<RepoExe, Long> {
    List<RepoExe> findByStorageAndProjectnameContaining(Storage storage, String keyword, Pageable pageable);
    List<RepoExe> findByStorageAndTypeAndProjectnameContaining(Storage storage, String type, String keyword, Pageable pageable);
